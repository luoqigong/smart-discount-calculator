      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-16 bg-white rounded-lg border border-gray-200 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="bg-amazon-orange/10 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-4">
                <Calculator className="w-6 h-6 text-amazon-orange" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">Multi-Item Shopping Cart</h3>
            ...
            <div className="text-center">
              <div className="bg-success-green/10 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-4">
                <div className="w-6 h-6 text-success-green">🏷️</div>
              </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Real-Time Smart Calculation</h3>
              <p className="text-gray-600 text-sm">
        ...
        <div className="mt-8 bg-white rounded-lg border border-gray-200 p-8">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-medium text-gray-900 mb-1">How accurate are the calculations?</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">Can I use this for any online store?</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">What types of discounts are supported?</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">How do quantity discounts work?</h3>
              <p className="text-gray-600 text-sm">
